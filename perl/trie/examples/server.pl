...
#!/usr/bin/env perl
{
	...
	my $propertyList = "Id,BrowserName,BrowserVendor,BrowserVersion," .
    ...
    # Create a device detection provider. Trie is very fast and does not
	# benefit from caching or pooling.
