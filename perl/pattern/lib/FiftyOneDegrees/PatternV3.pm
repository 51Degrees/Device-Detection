...
*fiftyoneDegreesMatchWithHeaders = *FiftyOneDegrees::PatternV3c::fiftyoneDegreesMatchWithHeaders;
...
############# Class : FiftyOneDegrees::PatternV3::fiftyoneDegrees_node_index_t_value ##############

package FiftyOneDegrees::PatternV3::fiftyoneDegrees_node_index_t_value;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( FiftyOneDegrees::PatternV3 );
%OWNER = ();
%ITERATORS = ();
*swig_characters_get = *FiftyOneDegrees::PatternV3c::fiftyoneDegrees_node_index_t_value_characters_get;
*swig_characters_set = *FiftyOneDegrees::PatternV3c::fiftyoneDegrees_node_index_t_value_characters_set;
*swig_integer_get = *FiftyOneDegrees::PatternV3c::fiftyoneDegrees_node_index_t_value_integer_get;
*swig_integer_set = *FiftyOneDegrees::PatternV3c::fiftyoneDegrees_node_index_t_value_integer_set;
sub new {
    my $pkg = shift;
    my $self = FiftyOneDegrees::PatternV3c::new_fiftyoneDegrees_node_index_t_value(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        FiftyOneDegrees::PatternV3c::delete_fiftyoneDegrees_node_index_t_value($self);
        delete $OWNER{$self};
    }
}
