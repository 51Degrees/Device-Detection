...
ZEND_NAMED_FUNCTION(_wrap_new_VectorString__SWIG_1) {
  ...
  /*@SWIG:/usr/local/share/swig/3.0.13/php5/utils.i,7,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_Match_getValues__SWIG_0) {
  ...
  /*@SWIG:/usr/local/share/swig/3.0.13/php5/utils.i,62,CONVERT_STRING_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_new_Provider__SWIG_3) {
  ...
  /*@SWIG:/usr/local/share/swig/3.0.13/php5/utils.i,2,CONVERT_BOOL_IN@*/
...
le_swig__p_std__string=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, (char *)SWIGTYPE_p_std__string->name, module_number);
