...
public partial class Provider : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Provider obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public bool getIsThreadSafe() {
    bool ret = FiftyOneDegreesTrieV3PINVOKE.Provider_getIsThreadSafe(swigCPtr);
    if (FiftyOneDegreesTrieV3PINVOKE.SWIGPendingException.Pending) throw FiftyOneDegreesTrieV3PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
