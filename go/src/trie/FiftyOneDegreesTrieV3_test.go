...
const LITE_DATA_FILE = "../../../data/51Degrees-LiteV3.4.trie"
...
func VectorStringToSlice(vector VectorString) []string{
    ...
    for i = 0; i < vector.Size(); i++ {
        tempSlice = append(tempSlice, vector.Get(int(i)))
    }
...
func SliceIndexOf(_properties []string, property string) int {
    for i := 0; i < len(_properties); i++ {
