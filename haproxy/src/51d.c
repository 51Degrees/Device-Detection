...
#ifdef FIFTYONEDEGREES_H_PATTERN_INCLUDED
            global._51degrees.cache = fiftyoneDegreesResultsetCacheCreate(&global._51degrees.data_set, global._51degrees.cache_size);
            global._51degrees.pool = fiftyoneDegreesWorksetPoolCreate(&global._51degrees.data_set, global._51degrees.cache, 10);
#endif
			break;
...
void deinit_51degrees(void)
{
    ...
    fiftyoneDegreesResultsetCacheFree(global._51degrees.cache);
